...
const useComponentState = (props, {
  ...
  const isHydrated = (0, import_use_did_finish_ssr.useDidFinishSSR)(),
    [startedUnhydrated] = (0, import_react.useState)(import_constants.IS_REACT_19 ? !isHydrated : !1),
  ...
  let setStateShallow = (0, import_createShallowSetState.createShallowSetState)(setState, void 0,
