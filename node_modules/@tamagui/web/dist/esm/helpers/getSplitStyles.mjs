import { isIos, isClient, isWeb, useIsomorphicLayoutEffect } from "@tamagui/constants";
...
function addStyleToInsertRules(rulesToInsert, styleObject, startedUnhydrated = !1) {
  {
    ...
    startedUnhydrated || shouldInsertStyleRules(identifier) && updateRules(identifier, styleObject[StyleObjectRules]), rulesToInsert[identifier] = styleObject;
  }
}
