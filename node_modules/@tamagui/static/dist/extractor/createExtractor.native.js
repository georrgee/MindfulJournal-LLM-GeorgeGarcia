...
function createExtractor() {
  ...
  function parseWithConfig(param, fileOrPath, options) {
    var { components, tamaguiConfig } = param, { config = "tamagui.config.ts", importsWhitelist = [
      "constants.js"
    ], evaluateVars = !0, sourcePath = "", onExtractTag, onStyleRule, getFlattenedNode, disable, disableExtraction, disableExtractInlineMedia, disableExtractVariables, disableDebugAttr, enableDynamicEvaluation = !1, includeExtensions = [
      ".ts",
      ".tsx",
      ".jsx"
        ...
        if (!(disable || shouldDisableExtraction || extractStyledDefinitions === !1) && !(!t.isIdentifier(path.node.callee) || path.node.callee.name !== "styled")) {
          ...
          if (t.isIdentifier(parentNode)) {
            ...
            if (!(!parentName || !definition || !t.isObjectExpression(definition))) {
              ...
              var out2 = getSplitStyles(styles, Component.staticConfig, defaultTheme, "", componentState, styleProps, void 0, void 0, void 0, !1, shouldPrintDebug), classNames = {
                ...out2.classNames
              };
...
`,
          ...
          var prev = null, getProps = function(props) {
            ...
            try {
              ...
              }, void 0, void 0, void 0, !1, debugPropValue || shouldPrintDebug), outProps2 = {
