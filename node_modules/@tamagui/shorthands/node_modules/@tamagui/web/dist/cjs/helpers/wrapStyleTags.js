...
var import_helpers = require("@tamagui/helpers"), import_constants = require("@tamagui/constants"), import_jsx_runtime = require("react/jsx-runtime");
function wrapStyleTags(styles, content) {
  return import_constants.IS_REACT_19 && styles.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    content,
