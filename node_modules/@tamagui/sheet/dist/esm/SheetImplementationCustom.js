...
const relativeDimensionTo = isWeb ? "window" : "screen", SheetImplementationCustom = React.forwardRef(
  function(props, forwardedRef) {
    const parentSheet = React.useContext(ParentSheetContext), {
      ...
      setMaxContentSize,
      maxSnapPoint
    } = providerProps, { open, controller, isHidden } = state, sheetRef = React.useRef(null), ref = useComposedRefs(forwardedRef, sheetRef, providerProps.contentRef), { animationDriver } = useConfiguration(), animationConfig = (() => {
