...
const { Provider: AccordionValueProvider, useStyledContext: useAccordionValueContext } = (0, import_core.createStyledContext)(), {
  Provider: AccordionCollapsibleProvider,
  useStyledContext: useAccordionCollapsibleContext
} = (0, import_core.createStyledContext)(), AccordionImplSingle = React.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    control,
...
}), { Provider: AccordionImplProvider, useStyledContext: useAccordionContext } = (0, import_core.createStyledContext)(), AccordionImpl = React.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeAccordion,
      disabled,
...
), ITEM_NAME = "AccordionItem", { Provider: AccordionItemProvider, useStyledContext: useAccordionItemContext } = (0, import_core.createStyledContext)(), AccordionItem = React.forwardRef(
  (props, forwardedRef) => {
...
const AccordionTriggerFrame = (0, import_core.styled)(import_collapsible.Collapsible.Trigger, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_core.View, { ref, height: itemContext.open ? height : 0, ...rest, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_core.View,
    {
      position: "absolute",
      width: "100%",
